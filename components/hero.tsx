      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            >
              <Button asChild size="lg" className="transition-transform hover:scale-105 bg-blue-500 hover:bg-blue-600 rounded-3xl dark:text-white">
                <Link href="#projects">
                  View My Work <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>

              <Button variant="secondary" size="lg" className="transition-transform hover:scale-105 rounded-3xl" onClick={handleDownloadCv}> 
