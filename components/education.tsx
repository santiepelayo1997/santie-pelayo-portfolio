  ...
  return (
    <section id="education" className="bg-muted/30 text-white md:py-24 py-20">
      <div className="container px-4 md:px-6 mx-auto md:max-w-5xl">
        ...
        >
          <motion.h2
            className="text-4xl md:text-5xl font-bold mb-12 md:mb-16 text-foreground/80 dark:text-foreground/80"
          ...
          <div className="grid gap-8">
            <div className="flex gap-4 items-center">
              ...
              <div>
                <div className="mb-1">
                  <p className="text-gray-400 sm:text-sm text-sm">Degree:</p>
                </div>
                <h3 className="max-sm:text-md text-lg font-semibold flex items-center gap-1 text-foreground/80 dark:text-foreground/80">
                ...
                <p className="text-gray-400 mt-1 sm:text-sm text-sm">
                  June 2014 - April 2018
                </p>
                <p className="mt-1 text-foreground/80 dark:text-foreground/80 text-sm">
